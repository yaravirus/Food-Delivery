					...
					<div class="row clearfix">
						...
						<div class="footer-column col-lg-3 col-md-6 col-sm-12">
							...
							<div class="footer-widget info-widget">
								...
								<ul class="email-list">
								<li>
									<a href="mailto:ixbdurgeshsharma@gmail.com">
									<i class="fa-solid fa-envelope" style="color:#FFD43B;font-weight:bold;font-size:28px;"></i>
									</a>
									</li>
									<li>
									<a href="https://www.linkedin.com/in/durgeshsharma000/">
									<i class="fa-brands fa-linkedin" style="color:#FFD43B;font-weight:bold;font-size:28px;"></i>
									</a>
									</li>
								</ul>
							</div>
