                        ...
                        for($i=0;$i<$max;$i++) {
                            if(isset($_SESSION['cart'][$i])) {
                                ...
                                foreach($_SESSION['cart'][$i] as $key => $val) {
                                    if($key=="nm") { $nm_session=$val; }
                                    if($key=="img1") { $img_session=$val; }
                                    if($key=="qty_total") { $qty_total_session=$val; }
                                    if($key=="price") { $price_session=$val; }
                                    if($key=="tb_id") { $tb_id_session=$val; }
                                    if($key=="unit") { $unit_session=$val; }
                                }
                            ...
                            <td class="prod-column">
                                <div class="column-box">
                                    <figure class="prod-thumb">
                                        <a href="#"><img src="../admin/<?php echo $img_session;?>" alt=""></a>
                                    </figure>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="qty">
                                <div class="item-quantity">
                                    <input class="quantity-spinner" type="text"
                                           value="<?php echo $qty_total_session;?>"
                                           id="qty<?php echo $i;?>" name="quantity">
                                </div>
                            </td>
            ...
            <div class="row clearfix">
                ...
                <div class="column pull-right col-lg-5 col-md-12 col-sm-12">
                    ...
                    <ul class="totals-table">
                        <li><h3>Payment Type</h3></li>
                        <li class="clearfix">
                            <input type="radio" name="r1" value="cod" checked> 
                            <span class="col" style="text-align:left;">Cash On Delivery</span>
                        </li>
                        <li class="clearfix">
                            <input type="radio" name="r1" value="paypal"> 
                            <span class="col" style="text-align:left;">Paypal</span>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <!--Totals Table-->
                        ...
                        <ul class="totals-table">
                            ...
                            <li class="clearfix">
                                ...
                                <span class="col">₹<?php echo $grand_total; ?></span>
                            </li>
                            <li class="text-right">
                                <button type="submit"
