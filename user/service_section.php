			...
			<div class="auto-container">
				<div class="row clearfix">
					...
					<div class="service-block col-lg-3 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="icon-box">
								<img src="/foodying/user/assets/images/resource/service-1.png" alt="" />
							</div>
					...
					<div class="service-block col-lg-3 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="icon-box">
								<img src="/foodying/user/assets/images/resource/service-2.png" alt="" />
							</div>
					...
					<div class="service-block col-lg-3 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="icon-box">
								<img src="/foodying/user/assets/images/resource/service-3.png" alt="" />
							</div>
					...
					<div class="service-block col-lg-3 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="icon-box">
								<img src="/foodying/user/assets/images/resource/service-4.png" alt="" />
							</div>
